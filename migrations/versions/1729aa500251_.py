...
Revision ID: 1729aa500251
Revises: a5cffa318ac2
Create Date: 2025-05-18 18:37:55.662269
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('subscription_date', sa.String(), nullable=True))
